...
const Page = () => {
  return (
    <div className="relative flex flex-col md:flex-row items-center justify-center gap-2 min-h-screen bg-[#0C011A] overflow-y-auto">
      ...
      <div className="relative w-full text-left z-10 flex flex-col md:flex-row items-center justify-center gap-2 px-6 md:px-8 max-w-[800px] mt-12 md:mt-0">
        <div className="flex flex-col gap-4 w-full md:w-auto p-2 bg-opacity-80 bg-gray-800 rounded-lg shadow-lg">
          ...
          <ul className="text-[12px] md:text-[16px] lg:text-[18px] text-gray-200 list-disc list-inside pl-5 space-y-2">
      ...
      <div className="absolute bottom-0 left-0 w-full text-center pb-0 mt-8"> {/* Добавлен отступ сверху */}
        <blockquote className="text-[8px] md:text-[14px] lg:text-[18px] text-gray-300 italic">
